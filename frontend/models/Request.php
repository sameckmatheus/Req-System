...
class Request {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " SET usuario_id=:usuario_id, descricao=:descricao, tipo=:tipo, status=:status, data_criacao=:data_criacao, prazo_exclusao=:prazo_exclusao";
    ...
    public function update() {
        $query = "UPDATE " . $this->table_name . " SET descricao = :descricao, tipo = :tipo, status = :status WHERE id = :id";
